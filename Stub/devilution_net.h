...
public:
	...
	private:
		...
		template<class mode> void process_data();
		template<class T> void process_element(encrypt_mode_t, T& x);
		template<class T> void process_element(decrypt_mode_t, T& x);
...
template<class mode> void devilution_net_udp::packet::process_data()
{
...
template<class T> void devilution_net_udp::packet::process_element(encrypt_mode_t, T& x)
{
...
template<class T> void devilution_net_udp::packet::process_element(decrypt_mode_t, T& x)
{
...
template<class T> const unsigned char* devilution_net_udp::packet::begin(const T& x)
{
	return reinterpret_cast<const unsigned char*>(&x);
}

template<class T> const unsigned char* devilution_net_udp::packet::end(const T& x)
{
