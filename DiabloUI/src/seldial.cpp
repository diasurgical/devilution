...
// 1001048A: using guessed type int __stdcall SRegLoadString(const char *, const char *, unsigned int, char *, unsigned
// int); 10022F8C: using guessed type char *off_10022F8C[4]; 10022F90: using guessed type char *off_10022F90[3];
...
// ref: 0x1000B0CF
int __stdcall SelDial_1000B0CF(HWND hWnd, UINT Msg, WPARAM wParam, LPARAM lParam)
{
    return 0;
}
/* {
...
// 1001048A: using guessed type int __stdcall SRegLoadString(const char *, const char *, unsigned int, char *, unsigned
// int); 10022F8C: using guessed type char *off_10022F8C[4];

// ref: 0x1000B614
int __fastcall SelDial_1000B614(HWND hWnd, int a2, int a3)
{
    return 0;
}
/* {
