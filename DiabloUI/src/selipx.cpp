...
// ref: 0x1000C692
int __stdcall SelIPX_1000C692(HWND hWnd, UINT Msg, WPARAM wParam, LPARAM lParam)
{
    return 0;
}
/* {
...
// ref: 0x1000CAC1
int UNKCALL SelIPX_1000CAC1(void* arg)
{
    return 0;
}
/* {
...
// ref: 0x1000CC41
int UNKCALL SelIPX_1000CC41(HWND hDlg)
{
    return 0;
}
/* {
...
// ref: 0x1000CCC5
int __fastcall SelIPX_1000CCC5(DWORD* a1)
{
    return 0;
}
/* {
...
// ref: 0x1000D18C
int UNKCALL SelIPX_1000D18C(HWND hWnd)
{
    return 0;
}
/* {
...
// ref: 0x1000D696
HWND __fastcall SelIPX_1000D696(HWND hDlg, int a2, int a3)
{
    return 0;
}
/* {
