...
// ref: 0x10008563
HWND __fastcall Modem_10008563(HWND hDlg, const char* a2, int a3)
{
    return 0;
}
/* {
...
// ref: 0x100085D8
int __stdcall Modem_100085D8(int a1, char* a2, char* a3)
{
    return 0;
}
/* {
...
// ref: 0x1000865F
int UNKCALL Modem_1000865F(char* arg)
{
    return 0;
}
/* {
...
// ref: 0x100086DE
int __stdcall Modem_100086DE(HWND hWnd, UINT Msg, WPARAM wParam, LPARAM lParam)
{
    return 0;
}
/* {
...
// ref: 0x100088DB
int UNKCALL Modem_100088DB(HWND hWnd)
{
    return 0;
}
/* {
...
// ref: 0x1000893D
int UNKCALL Modem_1000893D(HWND hWnd)
{
    return 0;
}
/* {
...
// ref: 0x10008A38
int __fastcall Modem_10008A38(HWND hWnd, int a2)
{
    return 0;
}
/* {
...
// ref: 0x10008BB7
int UNKCALL Modem_10008BB7(HWND hWnd)
{
    return 0;
}
/* {
...
// ref: 0x10008BFE
int UNKCALL Modem_10008BFE(HWND hWnd)
{
    return 0;
}
/* {
