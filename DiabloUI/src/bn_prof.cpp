...
// *a9)(DWORD, DWORD, DWORD, DWORD)) { return 0; }
/* {
    const char *v9; // eax
    int v10; // eax
...
// ref: 0x10001CF3
int UNKCALL bn_prof_10001CF3(HWND hWnd)
{
    return 0;
}
/* {
...
// int __stdcall UiProfileDraw(int a1, int a2, int a3, int a4, HGDIOBJ ho, int a6, int a7, int a8, int a9, int a10, int
// a11) { return 0; }
/* {
    int v11; // eax
    HFONT v12; // eax
...
// 10010394: using guessed type int __stdcall SGdiExtTextOut(DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD,
// DWORD); 1001039A: using guessed type int __stdcall SGdiGetTextExtent(DWORD, DWORD, DWORD); 100103A0: using guessed
// type int __stdcall SStrLen(DWORD); 100103A6: using guessed type int __stdcall SGdiSetPitch(DWORD); 100103AC: using
// guessed type int __stdcall SGdiSelectObject(DWORD); 100103B2: using guessed type int __stdcall SGdiImportFont(DWORD,
// DWORD); 100103B8: using guessed type int __stdcall SBltROP3Clipped(DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD,
// DWORD, DWORD, DWORD); 1002940C: using guessed type int dword_1002940C; 10029414: using guessed type int
// dword_10029414; 1002942C: using guessed type int dword_1002942C; 10001FC8: using guessed type CHAR Buffer[256];

// ref: 0x100021C4
int bn_prof_100021C4()
{
    return 0;
}
/* {
...
// ref: 0x100022A2
int UNKCALL bn_prof_100022A2(HWND hWnd)
{
    return 0;
}
/* {
...
// ref: 0x10002353
int UNKCALL bn_prof_10002353(HGDIOBJ h)
{
    return 0;
}
/* {
...
// ref: 0x10002749
int UNKCALL bn_prof_10002749(char* arg, DWORD* a2)
{
    return 0;
}
/* {
...
// ref: 0x10002782
DWORD* UNKCALL bn_prof_10002782(int* arg, int a2, int a3, int a4)
{
    return 0;
}
/* {
