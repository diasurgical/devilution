...
// 100103A0: using guessed type int __stdcall SStrLen(DWORD);
// 100103D0: using guessed type int __stdcall SRegSaveData(const char *, const char *, unsigned int, void *, unsigned
// int);
...
// ref: 0x10002B78
char* UNKCALL BNetGW_10002B78(DWORD* arg, char* a2)
{
    return 0;
}
/* {
...
// 100103D6: using guessed type int __stdcall SRegLoadData(const char *, const char *, unsigned int, void *, unsigned
// int, unsigned int *);
