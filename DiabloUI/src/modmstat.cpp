...
// ref: 0x10008C62
int __stdcall ModmStat_10008C62(char* a1, int a2, int a3, int a4, int a5)
{
    return 0;
}
/* {
...
// ref: 0x10008CA0
int __stdcall ModmStat_10008CA0(HWND hWnd, UINT Msg, WPARAM wParam, LPARAM lParam)
{
    return 0;
}
/* {
...
// ref: 0x10008DB3
int UNKCALL ModmStat_10008DB3(HWND hDlg)
{
    return 0;
}
/* {
